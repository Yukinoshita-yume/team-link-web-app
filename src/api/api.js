...
import { BASE_URL, CREATOR_URL, LOGIN_URL, REGISTER_URL, SELECTPAGE_URL, SEND_CODE_URL, USERINFO_URL, CREATECOMPETITION_URL, APPLYCOMPETITION_URL, JOINCOMPETITION_URL, ALLMEMBERS_URL, COMPETITIONDETAIL_URL} from './config';
...
export async function selectPageApi(page,pageSize,content) {
    try{
        const response=await api.post(SELECTPAGE_URL,{page,pageSize,content});
        return response;
    } catch(error){
        throw error;
    } 
...
export async function registerApi(userName,userPassword,userEmail,code) {
    try {
        const response = await api.post(REGISTER_URL,{userName,userPassword,userEmail,code});
        return response;
    } catch (error) {
        throw error;
    }
}
export async function changePasswordApi(userEmail,newPassword,confirmPassword,code) {
    try {
        const response = await api.put(url.CHANGE_PASSWORD_URL,{userEmail,newPassword,confirmPassword,code});
        return response;
    } catch (error) {
        throw error;
    }
...
export async function applyCompetitionApi(competitionId,userId){
    try {
        const response = await api.post(APPLYCOMPETITION_URL,{competitionId,userId});
        return response;
    } catch (error) {
        throw error;
    }
...
export async function joinCompetitionApi(competitionId,userId){
    try {
        const response = await api.post(JOINCOMPETITION_URL,{competitionId,userId});
        return response;
    } catch (error) {
        throw error;
    }
